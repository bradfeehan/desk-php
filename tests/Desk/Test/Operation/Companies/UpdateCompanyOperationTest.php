 ...
 * @group system
 */
class UpdateCompanyOperationTest extends UpdateOperationTestCase
{
    ...
    public function dataParameterValid()
    {
        ...
        return array(
            array(array('id' => 33, 'name' => 'foo'), array('body' => '#^{"name":"foo"}$#')),
            array(
                array('id' => 43, 'name' => 'foo', 'created_at' => $date),
                array('body' => '#^{"name":"foo","created_at":"2013-07-11T19:28:25Z"}$#'),
            ),
            array(
                array('id' => 53, 'name' => 'foo', 'domains' => 'example.com'),
